...
{
    public partial class Loginformnewoct : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "Select count(*) from Cust_Register where Cust_ID='"+USERID.Text+"' and Password='"+PASSWORD.Text+"' ;";
                int pass=(int)cmd.ExecuteScalar();
                Response.Write(pass);
                cmd.CommandText= "Select count(*) from Cust_Register where Cust_ID='" + USERID.Text + "' ;";
